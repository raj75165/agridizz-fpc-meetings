...
> **Important:** Configure your host to serve `index.html` for all routes (SPA fallback). The app uses a hash-based router, so this is handled automatically on most hosts.
